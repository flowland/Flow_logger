...
public class Main extends Application {
	...
	/*
	 * public HBox addHBox() { 
	 * HBox hbox = new HBox(); hbox.setPadding(new
	 * Insets(15, 12, 15, 12)); hbox.setSpacing(10); hbox.setStyle(
	 * "-fx-background-color: #336699;");
	 * 
	 * Label label1 = new Label("Kasutaja nimi: "); label1.setPrefSize(100, 20);
	 * 
	 * Label label2 = new Label("Auto reg. nr: "); label2.setPrefSize(100, 20);
